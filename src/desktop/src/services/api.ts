...
const API_BASE =
  ...
  (typeof process !== "undefined"
    ? process.env.STYX_DESKTOP_API_URL
    : undefined) ||
  "http://localhost:3000";
const DESKTOP_APP_VERSION =
  (typeof process !== "undefined"
    ? process.env.STYX_DESKTOP_APP_VERSION
    : undefined) || "0.0.0-dev";
const DESKTOP_APP_BUILD =
  (typeof process !== "undefined"
    ? process.env.STYX_DESKTOP_BUILD
    : undefined) || "dev";
...
export const api = {
  ...
  // B2B
  getEnterpriseMetrics: (id: string) => request<any>(`/b2b/metrics/${id}`),

  getEnterpriseBilling: (id: string) => request<any>(`/b2b/billing/${id}`),
