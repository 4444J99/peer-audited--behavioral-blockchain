  ...
  return (
    <div>
      ...
      >
        ...
        >
          {React.createElement(Database as any, { size: 18 })} Ledger Inspection
          Tool
        </h2>
        <button
      ...
      >
        <p style={{ color: "#888", marginBottom: "1rem" }}>
          Raw PostgreSQL Truth Log stream. Verifying systemic financial
          constraints.
        </p>
                ...
                <tr key={idx} style={{ borderBottom: "1px solid #222" }}>
                  ...
                  <td
                    style={{
                      ...
                      fontWeight: "bold",
                      color:
                        evt.type.includes("BURNED") ||
                        evt.type.includes("FRAUD")
                          ? "#DC2626"
                          : "#fff",
                      fontSize: "0.9rem",
                    }}
      ...
      <h3 style={{ fontSize: "1rem", marginBottom: "1rem", color: "#bbb" }}>
        System Integrity Snapshot
      </h3>
      <div
        style={{
      ...
      >
        ...
        >
          ...
          >
            {stats ? stats.avgIntegrity.toFixed(1) : "---"}{" "}
            {React.createElement(ArrowRightLeft as any, {
              size: 16,
              color: stats && stats.avgIntegrity >= 50 ? "#22c55e" : "#DC2626",
            })}
          </div>
        </div>
      </div>
