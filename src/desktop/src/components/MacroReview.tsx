...
export default function MacroReview() {
  ...
  const criticalCount = globalQueue.filter(
  ...
  return (
    <div>
      ...
      >
        ...
        >
          {React.createElement(Activity as any, { size: 18 })} Global Queue
          Health
        </h2>
        <button
          ...
          >
            ...
            <div
              style={{
                fontSize: "1.5rem",
                fontWeight: "bold",
                color: stats.pendingProofs > 0 ? "#eab308" : "#22c55e",
              }}
            >
              {stats.pendingProofs}
            </div>
          ...
          >
            ...
            <div
              style={{
                fontSize: "1.5rem",
                fontWeight: "bold",
                color: stats.avgIntegrity >= 50 ? "#22c55e" : "#DC2626",
              }}
            >
      ...
      {criticalCount > 0 && (
        ...
        >
          {React.createElement(ShieldAlert as any, {
            size: 24,
            color: "#DC2626",
          })}
          <div>
            ...
            >
              {criticalCount} Critical Intervention
              {criticalCount > 1 ? "s" : ""} Required
            </h3>
            <p
              style={{
                color: "#ff9999",
            ...
            >
              {criticalCount} item{criticalCount > 1 ? "s" : ""} in the queue
              require{criticalCount === 1 ? "s" : ""} immediate Judge approval.
            </p>
          </div>
        </div>
      )}
                ...
                <tr key={item.id} style={{ borderBottom: "1px solid #222" }}>
                  ...
                  <td
                    style={{
                      padding: "1rem 0",
                      fontWeight: "bold",
                      color: item.type === "HONEYPOT_FAIL" ? "#DC2626" : "#fff",
                    }}
                  >
                    {item.type}
                  </td>
