...
export default function B2BOrchestration() {
  ...
  const handleRevoke = async (keyId: string) => {
    ...
    try {
      ...
      setActionFeedback({
        type: "error",
        message: err.message || `Failed to revoke key ${keyId}`,
      });
    } finally {
      setRevokingId(null);
    }
  ...
  return (
    <div>
      ...
      >
        {React.createElement(Building2 as any, { size: 18 })} Enterprise
        Orchestration
      </h2>
      ...
      >
        <p style={{ color: "#888", margin: 0 }}>
          API Key management for Phase Omega B2B external integrations.
        </p>
      ...
      {showGenerateForm && (
        ...
        >
          ...
          <button
            ...
            style={{
              backgroundColor:
                generating || !enterpriseId.trim() ? "#333" : "#22c55e",
              color: generating || !enterpriseId.trim() ? "#666" : "#000",
              border: "none",
              padding: "0.5rem 1.5rem",
              fontWeight: "bold",
              cursor:
                generating || !enterpriseId.trim() ? "not-allowed" : "pointer",
              whiteSpace: "nowrap",
            }}
          >
                    ...
                    {k.active && (
                      <button
                        ...
                        style={{
                          padding: "0.25rem 0.5rem",
                          backgroundColor:
                            revokingId === k.id ? "#555" : "#333",
                          color: revokingId === k.id ? "#888" : "#fff",
                          border: "none",
                          cursor:
                            revokingId === k.id ? "not-allowed" : "pointer",
                          fontSize: "0.8rem",
                        }}
                      >
