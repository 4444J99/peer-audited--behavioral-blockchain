...
export default function ExilePanel() {
  ...
  return (
    <div>
      ...
      >
        {React.createElement(Skull as any, { size: 18 })} Exile Execution
        Protocol
      </h2>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Executing this function permanently burns the target's active
              stakes, blacklists their hardware identifier, and blocks future
              Stripe authorizations. This action is irreversible.
            </p>
          </div>
        </div>
        ...
        {confirmStep && (
          ...
          >
            ...
            >
              CONFIRM EXILE: Are you sure you want to permanently ban entity "
              {targetId}"?
            </p>
            <p
              style={{
        ...
        {!confirmStep && (
          ...
          >
            <button
              ...
              style={{
                backgroundColor:
                  targetId && reason && !isAuthorizing ? "#DC2626" : "#333",
                color: targetId && reason && !isAuthorizing ? "#fff" : "#666",
                border: "none",
                padding: "1rem 2rem",
                fontWeight: "bold",
                cursor:
                  targetId && reason && !isAuthorizing
                    ? "pointer"
                    : "not-allowed",
                display: "flex",
                alignItems: "center",
