...
export const AIPanel: React.FC<AIPanelProps> = ({ slide }) => {
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-fade-in pb-8">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 md:p-5 shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
          <h4 className="font-bold text-white flex items-center text-sm md:text-base">
            <Target className="w-4 h-4 mr-2 text-purple-400" /> Tailor Audience
          </h4>
          <select
            value={aiAudience}
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 md:p-5 shadow-lg">
        <h4 className="font-bold text-white flex items-center mb-2 text-sm md:text-base">
          <MessageSquare className="w-4 h-4 mr-2 text-red-400" /> Anticipate
          Questions
        </h4>
        <p className="text-xs text-neutral-400 mb-4 leading-relaxed">
          Simulate a hostile investor Q&A. Generate 3 hard questions.
        </p>
        <button
        ...
        {hardQuestions && (
          <div className="mt-4 space-y-4">
            {hardQuestions.map((qa, i) => (
              <div
                key={i}
                className="bg-neutral-950 p-3 md:p-4 rounded-lg border border-neutral-800 relative"
              >
                <div className="absolute top-0 left-0 w-1 h-full bg-red-500 rounded-l-lg"></div>
                <div className="text-sm text-red-400 font-bold mb-1 md:mb-2">
                  Q: {qa.question}
                </div>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 md:p-5 shadow-lg">
        <h4 className="font-bold text-white flex items-center mb-2 text-sm md:text-base">
          <Mic className="w-4 h-4 mr-2 text-blue-400" /> Delivery Coach
        </h4>
        <p className="text-xs text-neutral-400 mb-4 leading-relaxed">
          Get AI-generated stage directions and vocal emphasis tips.
        </p>
        <button
        ...
        {coachNotes && (
          <div className="mt-4 space-y-2">
            {coachNotes.map((note, i) => (
              <div
                key={i}
                className="bg-neutral-950 p-3 rounded-lg border border-neutral-800 flex items-start"
              >
                <span className="text-blue-400 mr-2 md:mr-3 font-bold">
                  {i + 1}.
                </span>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 md:p-5 shadow-lg">
        <h4 className="font-bold text-white flex items-center mb-2 text-sm md:text-base">
          <Zap className="w-4 h-4 mr-2 text-yellow-400" /> Explain with an
          Analogy
        </h4>
        <p className="text-xs text-neutral-400 mb-4 leading-relaxed">
          Generate a 1-sentence analogy to make this click instantly.
        </p>
        <button
