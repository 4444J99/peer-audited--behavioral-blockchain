  ...
  return (
    <div className="p-4 bg-gray-900 rounded-lg border border-gray-800">
      ...
      <p className="text-sm text-gray-400 mt-2">
        {strength < 0.2
          ? "Keep showing up. Every proof builds the groove."
          : strength < 0.4
            ? "You are building momentum. Consistency is key."
            : strength < 0.6
              ? "This is becoming part of your routine. Push through."
              : strength < 0.8
                ? "Strong habits resist disruption. You are almost there."
