  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
      ...
      <p className="text-sm text-neutral-400 mb-6 leading-relaxed">
        To participate in Styx, you must securely link a financial institution.
        This enables the protocol to automatically place FBO holds on your
        capital which are seized only upon verified failure.
      </p>
        ...
        <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="font-bold text-green-500">
              Identity & Capital Verified
            </span>
          </div>
          <p className="text-xs text-green-400/80">
            Account ending in •••• 4912 is linked. Escrow holding authority
            granted to Styx Protocol.
          </p>
        </div>
      )}
      ...
      <div className="mt-6 flex gap-2 items-start text-xs text-neutral-600">
        ...
        <p>
          Your banking credentials never touch Styx servers. Verification is
          routed through AES-256 encrypted Plaid endpoints.
        </p>
      </div>
    </div>
  );
