  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const completed = contractData.filter(
        ...
        setContracts({
          ...
          total,
          completionRate:
            settled > 0 ? Math.round((completed / settled) * 100) : 0,
        });
      } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans p-6 md:p-12 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Contract Summary */}
        <div className="p-8 bg-neutral-900 border border-neutral-800 rounded-3xl space-y-6">
          <h2 className="font-bold uppercase tracking-widest text-sm text-neutral-500">
            Contract Summary
          </h2>
