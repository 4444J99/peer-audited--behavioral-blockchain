...
export default function AdminPage() {
  ...
  const [resolveOutcome, setResolveOutcome] = useState<"COMPLETED" | "FAILED">(
    "COMPLETED",
  );
  ...
  const handleResolve = async () => {
    ...
    try {
      ...
      setResolveResult(
        `Contract ${resolveContractId.slice(0, 8)} resolved as ${resolveOutcome}.`,
      );
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans p-6 md:p-12 max-w-6xl mx-auto">
      <div className="mx-auto max-w-4xl px-4 py-3 mb-6 rounded-xl border border-amber-700/40 bg-amber-950/40 text-amber-200 text-xs font-bold uppercase tracking-wider text-center">
        OPERATOR CONSOLE — Administrative tools for platform management. In
        ...
        {disputesLoading ? (
          ...
          <div className="grid gap-4">
            {disputes.map((d) => (
              <div
                key={d.id}
                className="p-4 bg-neutral-900 border border-neutral-800 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4"
              >
                <div className="flex-1">
                  ...
                  <a
                    ...
                    className="text-xs text-blue-400 underline mt-2 inline-flex items-center gap-1"
                  >
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => {
                      setResolveContractId(d.contract_id);
                      setResolveOutcome("FAILED");
                      handleResolve();
                    }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-6 bg-neutral-900 border border-neutral-800 rounded-2xl space-y-4">
          ...
          <p className="text-neutral-500 text-sm">
            Inject a known-fail proof into the Fury queue to test auditor
            integrity.
          </p>
          <button
        ...
        <div className="p-6 bg-neutral-900 border border-neutral-800 rounded-2xl space-y-4">
          ...
          <select
            ...
            onChange={(e) =>
              setResolveOutcome(e.target.value as "COMPLETED" | "FAILED")
            }
