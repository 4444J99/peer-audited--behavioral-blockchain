        ...
        <div className="grid flex-1 items-center gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(420px,1.08fr)]">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 max-w-2xl text-xl font-medium leading-relaxed text-neutral-300">
              You are not weak for wanting contact. You are in the hardest part
              of the urge. Give this page ten minutes before you send anything.
            </p>
            ...
            <p className="mt-8 max-w-xl text-sm leading-6 text-neutral-500">
              If you might hurt yourself or someone else, contact local
              emergency services now. This tool is for an urge to break no
              contact, not a crisis response.
            </p>
          </div>
          ...
          <div className="border border-neutral-800 bg-neutral-900/80 p-4 shadow-[0_28px_80px_rgba(0,0,0,0.42)] sm:p-6">
            <div className="grid gap-4 lg:grid-cols-[1fr_220px]">
                ...
                <div className="mb-5 flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-neutral-500">
                      Pick the current minute. Do the smallest next action.
                    </p>
                  </div>
                  <TimerReset
                ...
                <div className="grid gap-3 sm:grid-cols-4">
                  {resetSteps.map((step, index) => (
                    ...
                    >
                      ...
                      <span className="mt-2 block text-sm font-bold leading-snug">
                        {step.title}
                      </span>
                    </button>
                  ))}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-white">
                        {resetSteps[activeStep].title}
                      </h3>
                      <p className="mt-3 text-base leading-7 text-neutral-300">
                        {resetSteps[activeStep].body}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <aside className="border border-red-900/60 bg-red-950/25 p-5">
                <ShieldCheck
                  className="mb-5 h-8 w-8 text-red-400"
                  aria-hidden="true"
                />
                <h2 className="text-xl font-black leading-tight text-white">
                  Need stronger structure after tonight?
                </h2>
                <p className="mt-3 text-sm leading-6 text-red-100/78">
                  Join the small iOS private beta for no-contact accountability.
                  The link carries this page source so the funnel keeps the urge
                  moment visible.
                </p>
                <Link
                  href={BETA_CTA_HREF}
            ...
            <div className="mt-4 grid gap-4 lg:grid-cols-[0.85fr_1.15fr]">
              <section className="border border-neutral-800 bg-neutral-950 p-5">
                ...
                <label
                  htmlFor="urge-level"
                  className="mt-6 block text-sm font-bold text-neutral-400"
                >
                ...
                <p className="mt-2 text-sm leading-6 text-neutral-500">
                  Feeling {selectedFeeling} does not require contact. It
                  requires a safer next action.
                </p>
              </section>
              ...
              <section className="border border-neutral-800 bg-neutral-950 p-5">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-neutral-500">
                      Use a friend, notes app, or your own inbox. Do not use
                      their thread.
                    </p>
                  </div>
                  <button
                    ...
                    onClick={() => {
                      const currentIndex =
                        replacementNotes.indexOf(replacementNote);
                      setReplacementNote(
                        replacementNotes[
                          (currentIndex + 1) % replacementNotes.length
                        ],
                      );
                    }}
