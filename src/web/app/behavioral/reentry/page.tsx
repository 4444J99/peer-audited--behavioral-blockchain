  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="p-4 bg-gray-900 rounded-lg border border-gray-800 text-sm text-gray-400 space-y-2">
        <p>
          Failure is not the end. The Re-entry Path gives you a structured way
          back after a contract fails.
        </p>
            ...
            {eligibility?.eligible ? (
              <>
                <p className="text-green-400 text-sm">
                  You are eligible for re-entry!
                </p>
                <div className="p-3 bg-gray-800 rounded-lg text-sm space-y-1">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Attempt:</span>
                    <span>#{eligibility.attemptNumber}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Discounted stake:</span>
                    <span className="text-green-400">
                      ${(eligibility.reducedStakeCents / 100).toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Phoenix bonus:</span>
              ...
              <p className="text-red-400 text-sm">
                {eligibility?.reason || "Unable to check eligibility."}
              </p>
            )}
          </div>
        )}
