    ...
    <>
      ...
      <section
        ...
        style={{
          ...
          minHeight: isHero || isCta ? "60vh" : undefined,
        }}
      >
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div
            data-reveal
            style={{ textAlign: isHero || isCta ? "center" : undefined }}
          >
      ...
      <div className="sketch-stage-overlay">
        {isHero ? (
          <>
            ...
            <span className="sketch-stage-subtitle">
              The Blockchain of Truth
            </span>
            <span className="scroll-hint" style={{ marginTop: "2rem" }}>
              scroll to explore ↓
            </span>
          </>
        ) : (
          <>
            <span className="sketch-stage-number">
