...
export class DashboardController {
  ...
  @Get("streak")
  @ApiOperation({
    summary: "Get 30-day streak chain with Never Miss Twice status",
  })
  ...
  @Get("unit-economics")
  @ApiOperation({
    summary: "Get CAC, LTV, cohort retention, and unit economics summary",
  })
  ...
  @ApiOperation({
    summary:
      "Issue a short-lived HttpOnly cookie for leaderboard SSE subscription",
  })
