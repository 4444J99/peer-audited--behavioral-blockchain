...
export type DangerWindowType =
  "DAY_3" | "DAY_21" | "WEEKEND" | "LATE_NIGHT" | "HIGH_STREAK_RISK";
...
export class DangerZoneService {
  ...
  async evaluateDangerWindows(
    contractId: string,
    timezone?: string,
  ): Promise<DangerWindow[]> {
  ...
  async getProtectionRecommendations(
    dangers: DangerWindow[],
  ): Promise<ProtectionRecommendation[]> {
      ...
      switch (d.type) {
        case "DAY_3":
          return {
            ...
            description:
              "The first 72 hours are the hardest — lean on your support network.",
          };
        case "DAY_21":
          return {
            type: d.type,
            ...
            description:
              "The extinction burst is the brain's last attempt to revert habits.",
          };
        case "WEEKEND":
          return {
            type: d.type,
            ...
            description:
              "Weekends carry less structure — plan ahead to stay on track.",
          };
        case "LATE_NIGHT":
          return {
            type: d.type,
        ...
        case "HIGH_STREAK_RISK":
          return {
            ...
            description:
              "Long streaks breed complacency — reconnect with your why.",
          };
        default:
          return {
            type: d.type,
            ...
            description:
              "Review your contract and check in with your support system.",
          };
      }
    });
  }
