...
describe("MedicalExemptionService", () => {
  ...
  beforeEach(() => {
    ...
    service = new MedicalExemptionService(
      mockPool as any,
      mockTruthLog as any,
      { resolveContract: jest.fn().mockResolvedValue(undefined) } as any,
    );
  });
