...
export class AmlController {
  ...
  @ApiOperation({
    summary: "Get AML screening history for a user (Admin only)",
  })
  ...
  @Post("sar")
  @ApiOperation({
    summary: "File a Suspicious Activity Report draft (Admin only)",
  })
  async fileSar(
    @Body()
    body: {
    ...
    if (
      ...
      throw new BadRequestException(
        "transactionIds (non-empty array) is required",
      );
    }
