...
export class AttestationController {
  ...
  async registerIosKey(
    @CurrentUser() user: any,
    @Body() body: AppAttestRegistration,
  ) {
  ...
  async verifyIosAssertion(
    @CurrentUser() user: any,
    @Body() body: AppAttestAssertion,
  ) {
  ...
  async verifyAndroidVerdict(
    @CurrentUser() user: any,
    @Body() body: PlayIntegrityVerdict,
  ) {
  ...
  @ApiOperation({
    summary:
      "Revoke a registered device attestation key (e.g., device compromise)",
  })
