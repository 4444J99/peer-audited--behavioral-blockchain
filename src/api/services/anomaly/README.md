...
This service is the **Fraud Detection Engine**. It uses ML heuristics and statistical analysis to flag suspicious proofs _before_ they reach the Fury Router.
...
- If ML analysis times out (> 10s), **Fail Open** (Pass to Fury Router with "Unverified" flag) to prevent UX blocking. _Exception: pHash duplicates must always fail._
