    ...
    <ScrollView style={styles.container} keyboardShouldPersistTaps="handled">
      ...
      <View style={[styles.section, styles.dangerSection]}>
        ...
        <Text style={styles.dangerDesc}>
          Permanently delete your account, all contracts, stakes, proof history,
          and Fury audit records. Active escrow holds will be cancelled and
          refunded. This action is irreversible.
        </Text>
        <TouchableOpacity
