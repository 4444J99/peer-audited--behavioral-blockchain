    ...
    return (
      <View style={styles.center}>
        <Text style={styles.errorText}>
          {parsedError.message || "Contract not found"}
        </Text>
        {parsedError.traceId ? (
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.statsGrid}>
        <View style={styles.statBox}>
          <Text style={styles.statValue}>
            ${(contract.stake_amount || 0).toFixed(2)}
          </Text>
        ...
        <View style={styles.statBox}>
          <Text style={styles.statValue}>
            {contract.grace_days_used || 0}/{contract.grace_days_max || 3}
          </Text>
      ...
      {contract.status === "ACTIVE" &&
        String(contract.oath_category || "").startsWith("RECOVERY_") && (
          <View style={{ gap: 12, marginBottom: 16 }}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                const targetLabel =
                  contract.metadata?.recovery?.noContactIdentifiers?.length > 0
                    ? "Target #1"
                    : "Restricted Target";
            ...
            >
              <Text style={[styles.attestButtonText, { color: "#ef4444" }]}>
                Automatic Scan
              </Text>
            </TouchableOpacity>
          </View>
