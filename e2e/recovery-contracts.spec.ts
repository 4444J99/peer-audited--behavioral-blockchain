...
test.describe("Recovery Contracts", () => {
  ...
  test("should display recovery oath category on contract creation", async ({
  ...
  test("should show contract creation form", async ({
    authenticatedPage: page,
  }) => {
    await page.goto("/contracts/new");
    await page.waitForLoadState("networkidle");
  ...
  test("should display safety acknowledgment requirements for recovery oath", async ({
    authenticatedPage: page,
  }) => {
    await page.goto("/contracts/new");
    await page.waitForLoadState("networkidle");
  ...
  test("should cap recovery contract duration at 30 days", async ({
    authenticatedPage: page,
  }) => {
    await page.goto("/contracts/new");
    await page.waitForLoadState("networkidle");
  ...
  test("should handle contract creation API call for recovery type", async ({
    authenticatedPage: page,
  }) => {
...
test.describe("Attestation Flow", () => {
  ...
  test("should navigate to attestation page and display attestation status", async ({
    authenticatedPage: page,
  }) => {
    // Mock the attestation status endpoint
    await page.route(
      `**/api/contracts/${mockContractId}/attestation`,
      (route) => {
  ...
  test("should submit attestation and show success state", async ({
    authenticatedPage: page,
  }) => {
    ...
    const attestButton = page.locator("button", {
      hasText: /I HELD THE LINE/i,
    });
  ...
  test("should show already-attested state when todayAttested is true", async ({
    authenticatedPage: page,
  }) => {
    await page.route(
      `**/api/contracts/${mockContractId}/attestation`,
  ...
  test("should display strike warning when totalStrikes > 0", async ({
    authenticatedPage: page,
  }) => {
    await page.route(
      `**/api/contracts/${mockContractId}/attestation`,
  ...
  test("should show Daily Check-In button on active recovery contract page", async ({
    authenticatedPage: page,
  }) => {
