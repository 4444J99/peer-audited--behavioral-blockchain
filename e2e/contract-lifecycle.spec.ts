...
test.describe("Contract Lifecycle", () => {
  test("should display contract creation form", async ({
  ...
  test("should show existing contracts on dashboard", async ({
    authenticatedPage: page,
  }) => {
  ...
  test("should create a contract via the form", async ({
    authenticatedPage: page,
  }) => {
  ...
  test("should display contract detail page", async ({
    authenticatedPage: page,
  }) => {
  ...
  test("should handle proof submission flow", async ({
    authenticatedPage: page,
  }) => {
    await page.route("**/api/contracts/contract-001", (route) =>
      route.fulfill({
