...
test.describe("Auth Guards", () => {
  ...
  test("should redirect unauthenticated user from /fury to /login", async ({
    page,
  }) => {
  ...
  test("should redirect unauthenticated user from /wallet to /login", async ({
    page,
  }) => {
  ...
  test("should redirect unauthenticated user from /contracts/new to /login", async ({
    page,
  }) => {
