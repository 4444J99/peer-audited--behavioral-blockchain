...
test.describe("Dashboard", () => {
  ...
  test("should display integrity score", async ({
  ...
  test("should handle onboarding wizard for new users", async ({
    authenticatedPage: page,
  }) => {
  ...
  test("should navigate to wallet from dashboard", async ({
    authenticatedPage: page,
  }) => {
    await page.goto("/dashboard");
    await page.waitForLoadState("networkidle");
  ...
  test("should navigate to fury from dashboard", async ({
    authenticatedPage: page,
  }) => {
