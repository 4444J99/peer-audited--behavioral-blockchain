...
Technical-feasibility analyses and operational docs for Styx. Module **specs** now live in [`docs/specs/`](../specs/); the _decisions_ behind this architecture are in the [Architecture Decision Records](../adr/) (`docs/adr/`).
