...
| The public Pages surface is a usable demo.                                      | Disputed by fresh check              | [Deployment observation](#deployment-observation)                                                                                                    | Root HTML and assets returned `200`, but documented API/launch routes returned `404`.      |
