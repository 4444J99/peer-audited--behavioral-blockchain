...
- **The Opportunity:** Styx is a "Granular" engine. For relationship recovery, we don't block the "Phone" app; we verify that you didn't _call a specific number_. This allows the user to live their life while maintaining the specific constraint.
...
_Reference Issue: #154 | Generated by Styx Research Agent_
