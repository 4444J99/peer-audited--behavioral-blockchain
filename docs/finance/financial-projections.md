...
_Consumer MRR = users x 0.5 contracts/mo x $9 net after Stripe_
...
_B2B MRR assumes tier mix: 60% Solo ($49), 30% Practice ($199), 10% Enterprise ($999)*
*Weighted avg B2B MRR/practitioner: $49(0.6) + $199(0.3) + $999(0.1) = $29.40 + $59.70 + $99.90 = $189.00_
...
_Headcount: first hire at M10 (support), second at M14 (engineering), third at M18 (growth)_
