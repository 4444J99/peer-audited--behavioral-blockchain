...
Records of significant architecture decisions for Styx — each captures the **context**, **decision**, and **consequences** of one choice. For the broader technical-feasibility analyses see [`docs/architecture/`](../architecture/); for module specs see [`docs/specs/`](../specs/).
...
| [ADR-004](adr--004-fury-consensus-engine.md)       | Fury Consensus Engine (3-auditor anonymous routing)    | [Spec: The Fury Router](../specs/spec--fury-router.md)                                         |
