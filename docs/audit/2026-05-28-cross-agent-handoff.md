...
ruleset (ID `16889701`) only went **live on 2026-05-28**. PR #607 (May 26) _introduced_
...
1. **Apply the ideal form:** Settings → Rules → `main-protection` → Required approvals
   `= 0` → Save. (Matches the file already in this PR; fixes _every_ future PR too.)
...
- Did **not** bypass or weaken any live security control from inside the container.
  The ruleset _file_ was set to the operator-authorized ideal form (`0` approvals) and
